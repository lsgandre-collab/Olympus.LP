...
const CHANNELS: { label: string; color: string; icon: React.ReactNode }[] = [
  {
    label: "WhatsApp",
    color: "#25D366",
  ...
  },
  {
    label: "Telegram",
    color: "#26A5E4",
    icon: <svg viewBox="0 0 24 24" fill="#26A5E4" className="w-5 h-5"><path d="M11.944 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0h-.056zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 01.171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.479.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>,
  },
  {
    label: "Slack",
    color: "#E01E5A",
  ...
  },
  {
    label: "Zapier",
    color: "#FF4A00",
    icon: <svg viewBox="0 0 24 24" fill="#FF4A00" className="w-5 h-5"><path d="M15.558 8.443h4.776l-3.34 3.34a6.005 6.005 0 010 .434l3.34 3.34h-4.776a6.005 6.005 0 01-.307.307v4.776l-3.34-3.34a6.005 6.005 0 01-.434 0l-3.34 3.34v-4.776a6.005 6.005 0 01-.307-.307H3.054l3.34-3.34a6.005 6.005 0 010-.434l-3.34-3.34h4.776c.09-.108.197-.215.307-.307V3.36l3.34 3.34a6.005 6.005 0 01.434 0l3.34-3.34v4.776c.11.092.216.199.307.307zM12 14.4a2.4 2.4 0 100-4.8 2.4 2.4 0 000 4.8z"/></svg>,
  },
  {
    label: "Notion",
    color: "#ffffff",
    icon: <svg viewBox="0 0 24 24" fill="#ffffff" className="w-5 h-5"><path d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L18.49 2.35c-.42-.326-.98-.7-2.055-.607L3.01 2.96c-.466.046-.56.28-.374.466l1.823 1.782zm.793 3.684v13.904c0 .746.373 1.026 1.214.98l14.523-.84c.84-.046.933-.56.933-1.166V6.92c0-.606-.233-.933-.746-.886l-15.177.886c-.56.047-.747.327-.747.933zm14.337.7c.093.42 0 .84-.42.886l-.7.14v10.264c-.606.327-1.166.514-1.633.514-.746 0-.933-.233-1.493-.933l-4.574-7.186v6.953l1.446.327s0 .84-1.166.84l-3.218.187c-.093-.187 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.093-.42.14-1.026.793-1.073l3.451-.233 4.76 7.28v-6.44l-1.213-.14c-.093-.514.28-.886.746-.933l3.23-.187zm-16.47-5.89L16.79 1.575c1.166-.093 1.446-.046 2.193.514l3.03 2.1c.653.467.84.653.84 1.213v16.377c0 1.026-.374 1.633-1.68 1.726L5.625 24c-.98.047-1.447-.093-1.96-.747L.793 19.927c-.56-.746-.793-1.306-.793-1.96V4.15c0-.84.374-1.54 1.306-1.633l2.016-.116z"/></svg>,
  },
];
      ...
      <div className="mx-auto max-w-5xl px-6 text-center relative z-10">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          {CHANNELS.map((ch) => (
            ...
            >
              <span className="transition-transform duration-300 group-hover:scale-110">{ch.icon}</span>
              {ch.label}
            </span>
          ))}
        </div>
