...
function WhatsAppPopup() {
  ...
  useEffect(() => {
    ...
    if (popupRef.current?.parentElement) {
      observer.observe(popupRef.current.parentElement);
    }
  ...
  return (
    <div
      ref={popupRef}
      className={`fixed bottom-24 right-6 w-72 bg-zinc-900 rounded-2xl shadow-2xl overflow-hidden transition-all duration-500 z-40 ${
    ...
    >
      <div className="bg-green-500 px-4 py-3 flex items-center gap-2">
        ...
        <span className="text-white font-semibold text-sm">ATLAS - Orquestrador</span>
        <button
      ...
      <div className="p-4 space-y-3">
        <p className="text-sm text-zinc-300 leading-relaxed">
          Andre, preço do SKU AMZN-4521 caiu 12% no concorrente. Ajustei automaticamente para R$47.90 mantendo margem de 28%. Quer que eu reverta?
        </p>
